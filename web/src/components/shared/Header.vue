...
<template>
    <div className="bg-transparent flex justify-between items-center px-4 py-2">
        ...
        <div>
            <nav>
                <ul className="flex capitalize font-medium w-[12rem] justify-between">
                    <router-link to="/" className="mr-8"><fa icon="fa-house"/> acceuil</router-link>
                    <router-link to="/admin"><fa icon="fa-solid fa-desktop"/> admin</router-link>
                </ul>
            </nav>
        </div>
